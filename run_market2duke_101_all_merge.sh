...
# Market to Duke
CUDA_VISIBLE_DEVICES=1,2 python model_test.py -dt duke --data-dir /home/ccvn/Workspace/trinh/data/reid --resume logs/market2duke_101_all_merge/target_fine_tuning/model_best.pth.tar --num-classes 900 --arch resnet101